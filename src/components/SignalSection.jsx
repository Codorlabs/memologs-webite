    ...
    <section className="py-32 bg-[#FBFBFD] relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 bg-background-dark border border-primary/10 rounded-full px-4 py-2 mb-6">
            <span className="material-symbols-outlined text-primary text-sm">filter_alt</span>
            <span className="text-sm font-medium text-primary">Signal vs Noise</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-[#1d1d1f] mb-6 tracking-tight">
            Focus on decisions that <span className="text-navy bg-clip-text text-transparent bg-gradient-to-r from-navy via-[#00cc9b] to-primary">actually matter</span>
          </h2>
        ...
        <div className="flex items-center justify-center gap-4 mb-16">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-500">Noise</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-primary">Signal</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="relative group">
            <div className="bg-white rounded-3xl border-2 border-gray-200 p-8 lg:p-10 h-full flex flex-col relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-6 relative">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center">
                    <span className="material-symbols-outlined text-gray-400 text-xl">volume_off</span>
                  </div>
                  <div>
                    <span className="text-xs font-bold uppercase tracking-widest text-gray-400">Skip These</span>
                    <h3 className="text-xl font-bold text-gray-700">Low-impact activities</h3>
                  </div>
                </div>
              ...
              {/* Subtitle */}
              <p className="text-gray-500 text-sm mb-6 border-l-2 border-gray-200 pl-4">
              ...
              <div className="space-y-3 flex-1 relative">
                <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-4 border border-gray-100 group/item hover:bg-gray-100 transition-colors cursor-default">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-600 text-sm">Routine ops & fixes</h4>
                    <p className="text-xs text-gray-400">Standard maintenance tasks</p>
                  </div>
                ...
                <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-4 border border-gray-100 group/item hover:bg-gray-100 transition-colors cursor-default">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-600 text-sm">Daily creative swaps</h4>
                    <p className="text-xs text-gray-400">A/B copy & image rotations</p>
                  </div>
                  <span className="material-symbols-outlined text-gray-300 text-lg">remove</span>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-4 border border-gray-100 group/item hover:bg-gray-100 transition-colors cursor-default">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-600 text-sm">Micro-optimizations</h4>
                    <p className="text-xs text-gray-400">Small bid & budget tweaks</p>
                  </div>
                  <span className="material-symbols-outlined text-gray-300 text-lg">remove</span>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-4 border border-gray-100 group/item hover:bg-gray-100 transition-colors cursor-default">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-600 text-sm">Housekeeping work</h4>
                    <p className="text-xs text-gray-400">Naming conventions, cleanup</p>
                  </div>
                  <span className="material-symbols-outlined text-gray-300 text-lg">remove</span>
                </div>
              </div>
          ...
          <div className="relative group lg:transform lg:scale-[1.02]">
            ...
            <div className="bg-background-dark rounded-3xl border-2 border-primary/20 p-8 lg:p-10 h-full flex flex-col relative shadow-xl shadow-primary/5">
              {/* Header */}
              ...
              {/* Subtitle */}
              <p className="text-white text-sm mb-6 border-l-2 border-primary/30 pl-4">
              ...
              <div className="space-y-3 flex-1">
                <div className="bg-primary/[0.03] p-4 rounded-xl flex items-center gap-4 border border-primary/10 hover:border-primary/30 hover:bg-primary/[0.06] transition-all cursor-default group/item">
                  <div className="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center text-primary">
                    <span className="material-symbols-outlined text-lg">attach_money</span>
                  </div>
                  <div className="flex-1">
                    <h4 className="font-semibold text-white text-sm">Moving money</h4>
                    <p className="text-xs text-gray-500">Budget re-allocation & major spend</p>
                  </div>
                ...
                <div className="bg-primary/[0.03] p-4 rounded-xl flex items-center gap-4 border border-primary/10 hover:border-primary/30 hover:bg-primary/[0.06] transition-all cursor-default group/item">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">Audience targeting & channel shifts</p>
                  </div>
                ...
                <div className="bg-primary/[0.03] p-4 rounded-xl flex items-center gap-4 border border-primary/10 hover:border-primary/30 hover:bg-primary/[0.06] transition-all cursor-default group/item">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">Creative strategy & hypotheses</p>
                  </div>
                ...
                <div className="bg-primary/[0.03] p-4 rounded-xl flex items-center gap-4 border border-primary/10 hover:border-primary/30 hover:bg-primary/[0.06] transition-all cursor-default group/item">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">Unexpected drops & recovery actions</p>
                  </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <div className="flex items-center justify-between text-xs mb-2">
                  <span className="text-white">Impact over time</span>
                  <span className="text-primary font-medium">Compounding</span>
                </div>
                <div className="h-12 w-full flex items-center px-4 bg-primary/[0.03] rounded-lg">
        ...
        <div className="text-center mt-20">
          <div className="inline-flex items-center gap-4 bg-background-dark border border-primary/10 rounded-2xl px-8 py-5 shadow-sm">
            <span className="material-symbols-outlined text-primary text-2xl">auto_awesome</span>
            <p className="text-lg md:text-xl text-white">
              MemoLogs keeps your log <span className="font-semibold text-primary">valuable</span> by keeping it <span className="font-semibold text-primary">focused</span>.
            </p>
          </div>
        </div>
      </div>
